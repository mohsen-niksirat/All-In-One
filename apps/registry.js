...
const APP_REGISTRY = [
    ...
    },
    {
        ...
        icon: '🪐',
        i18n: {
            fa: { name: 'منظومه شمسی', desc: 'مدارهای متحرک سیارات و مشخصات آن‌ها' },
            en: { name: 'Solar System', desc: 'Animated planet orbits & facts' },
            ar: { name: 'النظام الشمسي', desc: 'مدارات الكواكب المتحركة وبياناتها' },
        },
        tags: ['static'],
